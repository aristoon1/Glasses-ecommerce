...
<body>
  ...
  <section>
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Eyeglass frames</h3>
      <div class="row">

        <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='Glasses' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Glasses</h3>
      <div class="row">

      <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='Glasses1' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
